...
static void reset_confirmation_init(screen_t *scr){
	...
	switch(resStatus){
		case 0:
			ucg_WriteString(&ucg, 0, 0, strings[lang].RESET_Reset_msg_settings_1);
			ucg_WriteString(&ucg, 0, 16, strings[lang].RESET_Reset_msg_settings_2);
			break;
		case 1:
			ucg_WriteString(&ucg, 0, 0, strings[lang].RESET_Reset_msg_profile_1);
			ucg_WriteString(&ucg, 0, 16, strings[lang].RESET_Reset_msg_profile_2);
			break;
		case 2:
			ucg_WriteString(&ucg, 0, 0, strings[lang].RESET_Reset_msg_profile_1);
			ucg_WriteString(&ucg, 0, 16, strings[lang].RESET_Reset_msg_profile_2);
			break;
		case 3:
			ucg_WriteString(&ucg, 0, 0, strings[lang].RESET_Reset_msg_all_1);
			ucg_WriteString(&ucg, 0, 16, strings[lang].RESET_Reset_msg_all_2);
			break;
	}
}
